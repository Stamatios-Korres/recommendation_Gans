...
python3 ncf_spotlight.py  --use_gpu "True" \
                         --mlp_embedding_dim 16 --training_epochs 10 \
                         --learning_rate 3e-3 --l2_regularizer 1e-7  \
                         --batch_size 256 --dataset '20M' \
                          --k 3 \
                         --experiment_name "mlp_model_20M" --on_cluster 'True'
