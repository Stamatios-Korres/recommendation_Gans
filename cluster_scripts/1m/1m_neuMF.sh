...
python3 mf_spotlight.py  --use_gpu "True" \
                         --mlp_embedding_dim 16 --mf_embedding_dim 25 --training_epochs 50 \
                         --learning_rate 1e-3 --l2_regularizer 1e-5  \
                         --batch_size 256 --dataset '1M' \
                         --model neuMF --k 5 --neg_examples 5 \
                         --experiment_name "neuM_16x25_model_1M" --on_cluster 'True'

python3 mf_spotlight.py  --use_gpu "True" \
                         --mlp_embedding_dim 32 --mf_embedding_dim 50 --training_epochs 50 \
                         --learning_rate 1e-3 --l2_regularizer 1e-5\
                         --batch_size 256 --dataset '1M' \
                         --model mlp --k 5 --neg_examples 5 \
                         --experiment_name "neuMF_16x25_model_1M" --on_cluster 'True'
