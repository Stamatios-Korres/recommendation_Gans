...
python3 mf_spotlight.py  --use_gpu "True" \
                         ...
                         --learning_rate 0.0001 --l2_regulaarizer 1e-5  \
...
python3 mf_spotlight.py  --use_gpu "True" \
                         --embedding_dim 50 --training_epochs 50 \
                         --learning_rate 0.001 --l2_regularizer 1e-4 \
                         --batch_size 256 --dataset '1M' \
                         --k 5 --neg_examples 5 \
                         --experiment_name "100_matrix_model_1M_1e-4" --on_cluster 'True'


python3 mf_spotlight.py  --use_gpu "True" \
                         --embedding_dim 50 --training_epochs 50 \
                         --learning_rate 0.005 --l2_regularizer 1e-3 \
                         --batch_size 256 --dataset '1M' \
                         --k 5 --neg_examples 5 \
                         --experiment_name "25_matrix_model_1M_1e-3" --on_cluster 'True'

python3 mf_spotlight.py  --use_gpu "True" \
                         --embedding_dim 50 --training_epochs 50 \
                         --learning_rate 0.05 --l2_regularizer 1e-2 \
                         --batch_size 256 --dataset '1M' \
                         --k 5 --neg_examples 5 \
                         --experiment_name "25_matrix_model_1M_1e-2" --on_cluster 'True'
